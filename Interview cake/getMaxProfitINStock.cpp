...
int getMaxProfit(const vector<int>& stockPrices)
{
    ...
    // int maxProfit=-999999, currentProfit;
    ...
    int maxProfit=-99999, currentProfit;
    for(int sellTime=1; sellTime<stockPrices.size(); sellTime++){
        
        currentProfit=stockPrices[sellTime]-stockPrices[buyTime];
